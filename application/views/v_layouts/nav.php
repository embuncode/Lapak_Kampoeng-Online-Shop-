            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-2 col-md-6 col-xs-6">
                        <a href="home-04-light.html" class="biolife-logo"><img src="<?= base_url(); ?>assets/templates/images/organic-4.png" alt="biolife logo" width="135" height="36"></a>
                    </div>
                    <div class="col-lg-6 col-md-7 hidden-sm hidden-xs">
                        <div class="primary-menu">
                            <ul class="menu biolife-menu clone-main-menu clone-primary-menu" id="primary-menu" data-menuname="main menu">
                                <li class="menu-item"><a href="<?= base_url() ?>">Beranda</a></li>
                                <li class="menu-item"><a href="<?= base_url('about_us') ?>">Tentang</a></li>
                                <li class="menu-item"><a href="<?= base_url('produk') ?>">Belanja</a></li>
                                <li class="menu-item menu-item-has-children has-child">
                                    <a href="#" class="menu-name" data-title="Product">Produk</a>
                                    <ul class="sub-menu">
                        ...
                        <div class="biolife-cart-info">
                            <div class="mobile-search">
                                ...
                                <div class="mobile-search-content">
                                    <form id="form_search" class="form-search" name="mobile-search" action="<?php echo site_url('produk/search');?>" method="GET">
