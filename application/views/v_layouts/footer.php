<!-- FOOTER -->
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-9">
                        <section class="footer-item">
                            <a href="home-04-light.html" class="logo footer-logo"><img src="<?= base_url() ?>/assets/templates/images/organic-4.png" alt="biolife logo" width="135" height="36"></a>
    ...
    <script src="<?= base_url() ?>assets/templates/js/jquery-3.4.1.min.js"></script>
    <script src="<?= base_url() ?>assets/templates/js/bootstrap.min.js"></script>
    <script src="<?= base_url() ?>assets/templates/js/jquery.countdown.min.js"></script>
    <script src="<?= base_url() ?>assets/templates/js/jquery.nice-select.min.js"></script>
    <script src="<?= base_url() ?>assets/templates/js/jquery.nicescroll.min.js"></script>
