<?php
	...
	$list = $this->konfigurasi_model->listing();
		...
		<div class="flex-w p-b-90">
			<div class="w-size6 p-t-30 p-l-15 p-r-15 respon3">
				...
				<div>
					<p class="s-text7 w-size27">
						<?= $site->alamat ?><br>
						<i class="fa fa-envelope"></i> <?= $site->email ?><br>
						<i class="fa fa-phone"></i> <?= $site->telepon ?>
					</p>

					<div class="flex-m p-t-30">
						<a href="https://www.facebook.com/sharer.php?u=nexevo-demo.in/gopi/post/home" target="_blank" class="btn btn-info btn-sm" style="margin-right: 10px;"> <i class="fa fa-facebook"></i></a>
			...
			<div class="w-size7 p-t-30 p-l-15 p-r-15 respon4">
				...
				<ul>
					...
					<li class="p-b-9">
						<a href="http://sigit-wasis.github.io" class="s-text7">
							Web Developer
						</a>
					</li>
			...
			<div class="w-size8 p-t-30 p-l-15 p-r-15 respon3">
				<h4 class="s-text12 p-b-30">
					...
					<a href="https://api.whatsapp.com/send?phone=082281488568&amp;text=Halo%20admin,%20Saya%20mau%20nanya....."><img src="https://lh3.googleusercontent.com/-N23V4qsFKs8/WMV9mGK5x5I/AAAAAAAAAPQ/BcC6qzLzJtcqKUWAX5TXX8KxuwDX5JXAgCLcB/h90/Button%2BChat%2Bvia%2BWhatsapp.png" style="max-width: 50%; padding-bottom: 20px;" / />
					</a>
